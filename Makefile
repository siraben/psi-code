...
$(BUILD_DIR)/agent.o: src/core/agent.c include/psi/abort.h include/psi/agent.h include/psi/common.h include/psi/session.h
	$(CC) $(CPPFLAGS) $(LOCAL_CPPFLAGS) $(BASE_CFLAGS) $(CFLAGS) -c $< -o $@

$(BUILD_DIR)/common.o: src/core/common.c include/psi/common.h
	$(CC) $(CPPFLAGS) $(LOCAL_CPPFLAGS) $(BASE_CFLAGS) $(CFLAGS) -c $< -o $@

$(BUILD_DIR)/http_client.o: src/core/http_client.c include/psi/abort.h include/psi/common.h include/psi/http_client.h
	$(CC) $(CPPFLAGS) $(LOCAL_CPPFLAGS) $(BASE_CFLAGS) $(CFLAGS) -c $< -o $@
...
$(BUILD_DIR)/vm.o: src/lua/vm.c include/psi/common.h include/psi/embedded_lua.h include/psi/host_ops.h include/psi/http_async.h include/psi/http_client.h include/psi/message.h include/psi/process.h include/psi/session.h include/psi/vm.h
	$(CC) $(CPPFLAGS) $(LOCAL_CPPFLAGS) $(BASE_CFLAGS) $(CFLAGS) -c $< -o $@
